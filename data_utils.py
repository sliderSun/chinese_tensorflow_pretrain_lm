...
class TrainingDatasetSpanBERT(TrainingDataset):
    """预训练数据集生成器（BERT）
    """
    ...
    def __init__(
        ...
        """参数说明：
            ...
            word_segment是任意分词函数。
        """
        super(TrainingDatasetSpanBERT, self).__init__(tokenizer, sequence_length)
        self.word_segment = word_segment
        self.mask_rate = mask_rate
    ...
    def paragraph_process(self, texts):
        ...
        ends = [self.token_sep_id, 0]
        paddings = [self.token_pad_id, 0]
        return super(TrainingDatasetSpanBERT,
                     self).paragraph_process(texts, starts, ends, paddings)
...
class TrainingDatasetBERT(TrainingDataset):
    """预训练数据集生成器（BERT）
    """
    ...
    def __init__(
        ...
        """参数说明：
            ...
            word_segment是任意分词函数。
        """
        super(TrainingDatasetBERT, self).__init__(tokenizer, sequence_length)
        self.word_segment = word_segment
        self.mask_rate = mask_rate
    ...
    def paragraph_process(self, texts):
        ...
        ends = [self.token_sep_id, 0]
        paddings = [self.token_pad_id, 0]
        return super(TrainingDatasetBERT,
                     self).paragraph_process(texts, starts, ends, paddings)
