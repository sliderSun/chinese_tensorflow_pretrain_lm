...
@Time : 2022/9/6 15:20 
@Author : sunshb10145 
@File : simbert_v2_stage2.py 
@desc: SimBERT_v2预训练代码stage2，把simbert的相似度蒸馏到roformer-sim上
...
# bert配置
config_path = './model/chinese_roformer-sim-char-ft_L-12_H-768_A-12/bert_config.json'
checkpoint_path = './model/chinese_roformer-sim-char-ft_L-12_H-768_A-12/bert_model.ckpt'
dict_path = './model/chinese_roformer-sim-char-ft_L-12_H-768_A-12/vocab.txt'
