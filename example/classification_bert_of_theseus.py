"""
@Time : 2022/8/29 23:03 
@Author : sunshb10145 
@File : classification_bert_of_theseus.py 
@desc:
"""
"""
...
from bert4keras.layers import Input, Lambda, Dense, Layer
...
train_data = load_data(
    './iflytek_public/train.json'
)
valid_data = load_data(
    './iflytek_public/dev.json'
)
